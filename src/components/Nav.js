...
<IconButton 
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', justifyContent: 'end', gap: '1rem' } }}>
                            ...
                            <Button onClick={handleContact}
                                sx={{ my: 2, color: 'white', display: 'block', '&:hover': { backgroundColor: 'rgb(61, 120, 102)', height: '100%' }  }}>Contact
                            </Button>
                            {/* <Button onClick={handleEmployeeDetails}
                                sx={{ my: 2, color: 'white', display: 'block', '&:hover': { backgroundColor: 'rgb(61, 120, 102)', height: '100%' }  }}>Employee Details
                            </Button> */}
